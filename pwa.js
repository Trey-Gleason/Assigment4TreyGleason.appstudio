...
const cacheName = 'Assigment4TreyGleason-2021-04-05 22:00:34.565686'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Assigment4TreyGleason'.length) === 'Assigment4TreyGleason') {
